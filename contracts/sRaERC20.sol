...
contract sRaERC20Token is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked RaDAO", "sRA", 9) ERC20Permit() {
    ...
    /**
        @notice increases sRA supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sRA
